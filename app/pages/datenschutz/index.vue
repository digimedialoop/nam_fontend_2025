...
<h2>Hosting</h2>
<p>Unsere Website wird bei <strong>Vercel</strong> gehostet. Der Zugriff erfolgt über Serverinfrastruktur mit Standorten in der EU. Es gelten die Datenschutzrichtlinien von Vercel: <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">https://vercel.com/legal/privacy-policy</a>.</p>
...
<h3>Zusätzlich setzen wir Matomo und Umami (ohne Cookies) ein</h3>
<p>Folgende Daten werden dabei anonymisiert erhoben:</p>
<ul>
  <li>IP-Adresse (gekürzt)</li>
  <li>aufgerufene Seite</li>
  <li>Referrer-URL</li>
  <li>verlinkte Unterseiten</li>
  <li>Verweildauer</li>
